...
region, month, input_folder_path, topic_modeling_folder_path, sentiment_model_path, output_folder_path, generic_model = sys.argv[
                                                                                                                        1:8]
...
for file_path in input_path.glob(f"tweets_{region}_en_{month_index}.txt"):
