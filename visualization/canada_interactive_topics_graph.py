...
df = pd.read_csv('canada_topics_similaritiesWord2VecCosine.csv', names=['Month', 'TopicA', 'TopicB', 'similarity'])
...
original_fig = go.Figure(
    data=traces,
    layout=go.Layout(
        title="Canada",  # Title of the figure
        showlegend=False,
        hovermode="closest",
...
app = Dash(__name__)
app.layout = html.Div([
    html.H1("Interactive Network Graph of Canada Topics"),  # Title of the web app
