...
for month in months:
    file = open(
        "D:/Research/UBC/covid19/visualization/us-"
        + month
        + "-2021/"
        + "topics.txt",
        "r",
...
df = pd.read_csv('us_topics_similaritiesWord2VecCosine.csv', names=['Month', 'TopicA', 'TopicB', 'similarity'])
...
app = Dash(__name__)
app.layout = html.Div([
    html.H1("Interactive Network Graph of US Topics"),  # Title of the web app
